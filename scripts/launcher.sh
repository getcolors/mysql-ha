...
grep -q "getcolors/once#$once_sha" "$root/skills/package-mysql-ha-red/red" || fail 'red payload PINS ONCE pin differs from green'
...
red_launcher="$root/skills/package-mysql-ha-red/red"
