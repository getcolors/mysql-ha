...
diff -r --exclude=__pycache__ "$root/green/src/resources/io/github/getcolors/mysql_ha" "$root/red/resources"
diff -r --exclude=__pycache__ "$root/green/src/resources/io/github/getcolors/mysql_ha" "$root/blue/src/package_mysql_ha_blue/resources"
