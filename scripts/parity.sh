...
# MYSQL_HA_LIB_ROOT overrides), while green, red, and blue stay on their
# pins — a change that lands here passes parity before it is pushed or
# pinned anywhere.
...
diff -r "$root/green/src/resources/io/github/getcolors/mysql_ha" "$root/red/resources"
diff -r "$root/green/src/resources/io/github/getcolors/mysql_ha" "$root/blue/src/package_mysql_ha_blue/resources"

echo "green, red, and blue mysql-ha artifacts are byte-identical"
